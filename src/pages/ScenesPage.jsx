...
export function ScenesPage({ onNavigateHome, onOpenSection }) {
  ...
  const categories = [
    { id: 'all', label: 'All Scenes', count: 12 },
    { id: 'intimate', label: 'Intimate Moments', count: 5 },
    { id: 'playful', label: 'Playful Adventures', count: 4 },
    { id: 'artistic', label: 'Artistic Expression', count: 3 }
  ]
  ...
  const sceneGallery = [
    {
      ...
      duration: "18 min",
      quality: "4K",
      preview: "A tender exploration of connection in soft morning light",
      tags: ["Sensual", "Natural Light", "Authentic"],
      subscribers: 2847,
      rating: 4.9,
      hashCode: "#IVY_ML_001"
    },
    {
      ...
      duration: "25 min",
      quality: "4K",
      preview: "Vulnerable conversations leading to deep intimacy",
      tags: ["Emotional", "Raw", "Connection"],
      subscribers: 3210,
      rating: 5.0,
      hashCode: "#IVY_MC_002"
    },
    {
      ...
      duration: "15 min",
      quality: "4K",
      preview: "Laughter, teasing, and spontaneous moments of joy",
      tags: ["Fun", "Spontaneous", "Laughter"],
      subscribers: 1892,
      rating: 4.8,
      hashCode: "#IVY_PA_003"
    },
    {
      ...
      duration: "22 min",
      quality: "4K",
      preview: "Art meets passion in this visually stunning piece",
      tags: ["Artistic", "Visual", "Creative"],
      subscribers: 2156,
      rating: 4.9,
      hashCode: "#IVY_CD_004"
    },
    {
      ...
      duration: "31 min",
      quality: "4K",
      preview: "Adventure and intimacy during a romantic escape",
      tags: ["Adventure", "Romance", "Travel"],
      subscribers: 2634,
      rating: 4.8,
      hashCode: "#IVY_WG_005"
    },
    {
      ...
      duration: "19 min",
      quality: "4K",
      preview: "Playing with shadows to create intimate atmosphere",
                  ...
                  <div className="flex flex-1 flex-col space-y-4 p-5 sm:p-6">
                    ...
                    <div className="rounded-2xl border border-caramel/15 bg-gradient-to-r from-caramel/10 to-sienna/10 p-4">
                      <div className="flex items-center justify-between mb-2">
                        <p className="text-xs font-medium text-caramel uppercase tracking-wide">Want this video?</p>
                        <button
                          onClick={(event) => {
                      ...
                      <p className="text-xs text-blush/70 mt-2 leading-relaxed">
                        Copy this code and send it in a DM on OnlyFans to request this specific video
                      </p>
                    </div>
                    ...
                    <div className="mt-auto flex items-center justify-between border-t border-white/10 pt-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-blush/70">{scene.subscribers.toLocaleString()} viewers</span>
                      </div>
          ...
          <FadeIn delay={800}>
            <div className="text-center mt-16 space-y-8">
              ...
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-caramel">Ready for the full experience?</h3>
                ...
                <div className="bg-gradient-to-r from-white/10 to-white/5 rounded-2xl p-6 border border-caramel/20 backdrop-blur-sm max-w-3xl mx-auto">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="text-left">
                      <h4 className="text-lg font-semibold text-caramel mb-2">How to request specific videos:</h4>
                      <ol className="text-sm text-blush/80 space-y-1 leading-relaxed">
                        <li><strong className="text-caramel">1.</strong> Copy the hashtag code from any video above</li>
                        <li><strong className="text-caramel">2.</strong> Click "Send DM for Videos" to go to our OnlyFans</li>
                        <li><strong className="text-caramel">3.</strong> Send us a direct message with the code</li>
                        <li><strong className="text-caramel">4.</strong> We'll send you that specific video privately!</li>
                      </ol>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative space-y-6 p-6 sm:p-8">
              ...
              <div className="rounded-2xl border border-caramel/15 bg-gradient-to-r from-caramel/10 to-sienna/10 p-4">
                <div className="mb-2 flex items-center justify-between gap-3">
                  <p className="text-xs font-medium uppercase tracking-wide text-caramel">Request code</p>
                  <button
                    type="button"
                  ...
                  >
                    {copiedCode === selectedScene.hashCode ? 'Copied' : 'Copy'}
                  </button>
                </div>
                ...
                <p className="mt-2 text-xs leading-relaxed text-blush/70">
                  Send this code in a DM on OnlyFans to request this specific video.
                </p>
              </div>
